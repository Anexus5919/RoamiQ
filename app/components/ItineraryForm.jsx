...
export default function ItineraryForm({ onSubmit, isLoading }) {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-[1fr_auto_1fr] items-end gap-2 md:gap-4"> {/* Grid for 3 columns */}
        {/* From Field */}
        <div>
        ...
        <button
          ...
          className="p-2 mb-1 rounded-md text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
          aria-label="Swap locations"
          title="Swap locations" // Tooltip for accessibility
        >
